...
export const HeroSectionBg = ({
  ...
  return (
    <div className={cn("sticky top-64 sm:top-72 md:top-80", className)}>
      <p className="text-5xl sm:text-6xl md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300 font-montserrat">
        {title}
      </p>
      <p className="w-[70%] text-pretty md:w-auto text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description}
      </p>
      <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute overflow-x-clip">
        <button
          className="font-bold flex flex-row gap-2 items-center bg-white rounded-full px-4 py-2 md:mt-24 mt-8 z-30 text-base text-black w-fit mx-auto "
        ...
        >
          ...
          <svg
            ...
            role="presentation"
            viewBox="0 0 24 24"
            className="group-hover:translate-x-0.5 outline-none transition-transform rotate-90"
            tabIndex={-1}
          >
            <path
              fill="currentColor"
      ...
      <svg
        ...
        className="absolute -top-32 md:-top-60 -left-[50vw] translate-x-[50vw] lg:translate-x-0 lg:left-0 min-w-[1024px] md:w-full"
        aria-label="entrar"
      >
        <motion.path
